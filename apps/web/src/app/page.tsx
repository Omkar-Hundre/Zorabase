    ...
    <div className="min-h-screen bg-[#030303] text-zinc-100 selection:bg-indigo-500/30 selection:text-indigo-200 relative overflow-hidden font-sans">
      ...
      <header className="sticky top-0 z-50 border-b border-white/[0.06] bg-[#030303]/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between relative">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <span className="text-lg font-bold tracking-tight text-white">Zorabase</span>
          </Link>
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-28 space-y-36">
        ...
        <section className="text-center max-w-4xl mx-auto space-y-8 pt-8">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full border border-emerald-500/20 bg-emerald-500/[0.08] text-[11px] font-medium tracking-wide text-emerald-400 font-mono">
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
            <span>Sub-15ms CDC Replication · Zero-Bandwidth S3</span>
          </div>

          {/* Editorial Display Headline with Clean Inter */}
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold text-white tracking-[-0.035em] leading-[1.08]">
        ...
        <section id="benchmarks" className="rounded-2xl border border-white/[0.08] bg-[#09090b]/80 backdrop-blur-md p-8 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          <div>
            <div className="text-3xl sm:text-5xl font-extrabold text-indigo-400 tracking-tight">&lt; 15ms</div>
            <div className="text-[11px] text-zinc-400 mt-1 uppercase tracking-wider font-mono font-medium">CDC Broadcast Latency</div>
          </div>
          <div>
            <div className="text-3xl sm:text-5xl font-extrabold text-emerald-400 tracking-tight">5,000+ QPS</div>
            <div className="text-[11px] text-zinc-400 mt-1 uppercase tracking-wider font-mono font-medium">Query Engine Capacity</div>
          </div>
          <div>
            <div className="text-3xl sm:text-5xl font-extrabold text-blue-400 tracking-tight">0 MB</div>
            <div className="text-[11px] text-zinc-400 mt-1 uppercase tracking-wider font-mono font-medium">Server Bandwidth on Uploads</div>
          </div>
          <div>
            <div className="text-3xl sm:text-5xl font-extrabold text-purple-400 tracking-tight">10,000+</div>
            <div className="text-[11px] text-zinc-400 mt-1 uppercase tracking-wider font-mono font-medium">WebSockets / Node</div>
          </div>
        </section>
        ...
        <section className="rounded-3xl border border-white/[0.08] bg-[#09090b] p-8 sm:p-14 shadow-2xl space-y-6 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 pt-2 relative z-10">
            <Link
              href="/register"
              className="w-full sm:w-auto h-11 px-7 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-xs font-semibold text-white transition-all shadow-[0_0_20px_rgba(99,102,241,0.35)] flex items-center justify-center gap-2"
            >
            ...
            <Link
              href="/dashboard/docs"
              className="w-full sm:w-auto h-11 px-6 rounded-xl border border-white/[0.08] hover:bg-white/[0.04] text-xs font-semibold text-zinc-300 transition-colors flex items-center justify-center"
            >
              Read Docs
            </Link>
          </div>
        ...
        <div className="flex justify-center -mb-20 overflow-hidden select-none pointer-events-none">
          <span className="brand-watermark-text font-black">ZORABASE</span>
        </div>
      </main>
